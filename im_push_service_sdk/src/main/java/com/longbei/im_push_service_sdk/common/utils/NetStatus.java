package com.longbei.im_push_service_sdk.common.utils;
...
//									if(callback != null) callback.sendNetStatus(true, NET_WIFI);
								...
								else
								{
									...
									{
										L.debug("","net work type: " + telmng.getNetworkType());
										Intent it = new Intent(B_NET_CONNECTED);
...
//												if(callback != null) callback.sendNetStatus(true, NET_3G);
			...
			{
				L.debug("","netReceiver=" + e1.toString());
			}
		}
	};
...
//						Logger.i("getHostName:" + inetAddress.getHostName());
		...
		{
			L.debug("","getLocalIpAddress() " + e1.toString());
		}
		return null;
	}
	...
	public void destory()
	{
		...
		catch (Exception e1){L.debug("","NetStatus() destory()=" + e1.toString());}
	}
}
