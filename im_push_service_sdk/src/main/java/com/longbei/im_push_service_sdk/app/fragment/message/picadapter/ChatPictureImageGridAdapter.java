package com.longbei.im_push_service_sdk.app.fragment.message.picadapter;
 ...
 */
public class ChatPictureImageGridAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ChatPictureImageGridAdapter(Context context, PictureSelectionConfig config) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.chat_picture_image_grid_item, parent, false);
