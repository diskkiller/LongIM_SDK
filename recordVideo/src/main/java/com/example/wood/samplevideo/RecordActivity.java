...
public class RecordActivity extends AppCompatActivity {
    ...
    private Button ringProgressBar;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ringProgressBar = (Button) findViewById(R.id.ringProgressBar);
        ringProgressBar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (haveEnoughSpace) {
                    checkCameraPermission();
                } else {
                    Toast.makeText(RecordActivity.this, "剩余空间不够充足，请清理一下再试一次", Toast.LENGTH_SHORT).show();
                }
            }
        });
