...
public class MovieRecorderView extends LinearLayout implements OnErrorListener {
    ...
    public MovieRecorderView(Context context, AttributeSet attrs, int defStyle) {
        ...
        recordMaxTime = a.getInteger(R.styleable.MovieRecorderView_record_max_time, 60);//默认最大拍摄时间为10s
...
//        mediaRecorder.setVideoFrameRate(20);//TODO 设置每秒帧数 这个设置有可能会出问题，有的手机不支持这种帧率就会录制失败，这里使用默认的帧率，当然视频的大小肯定会受影响
        ...
        if (sizePicture < 3000000) {//这里设置可以调整清晰度
            ...
            mediaRecorder.setVideoEncodingBitRate(2 * 800 * 500);
        }
        mediaRecorder.setOrientationHint(90);//输出旋转90度，保持竖屏录制
        //mediaRecorder.setMaxDuration(Constant.MAXVEDIOTIME * 1000);
        Log.e(LOG_TAG, "视频输出目录===="+recordFile.getAbsolutePath());
