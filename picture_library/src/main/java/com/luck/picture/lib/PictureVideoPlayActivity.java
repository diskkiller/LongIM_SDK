...
import com.luck.picture.lib.video.MediaHelp;
import com.luck.picture.lib.video.VideoMediaController;
import com.luck.picture.lib.video.VideoSuperPlayer;
...
public class PictureVideoPlayActivity extends PictureBaseActivity implements
    ...
    private VideoSuperPlayer mVideoView;
    ...
    protected void initWidgets() {
        ...
        if (mVideoView.mPlayer != null) {
            mVideoView.mPlayer.release();
            mVideoView.mPlayer = null;
        }

        //mVideoView.loadAndPlay(MediaHelp.getInstance(), videoUrl,0, false);
        mVideoView.setPageType(VideoMediaController.PageType.EXPAND);
        mVideoView.setVideoPlayCallback(new VideoSuperPlayer.VideoPlayCallbackImpl() {
    ...
    public void onStart() {
        ...
        mVideoView.loadAndPlay(MediaHelp.getInstance(), videoPath,0, false);
    ...
    public void onResume() {
        ...
        if (mPositionWhenPaused >= 0) {
            //mVideoView.seek(mPositionWhenPaused);
            mVideoView.loadAndPlay(MediaHelp.getInstance(), videoPath,mPositionWhenPaused, true);
