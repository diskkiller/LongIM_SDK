...
import com.luck.picture.lib.FileSizeUtil;
...
public class CustomCameraView extends RelativeLayout {
    ...
    public void initView() {
        ...
        mCameraView.setCaptureMode(CameraView.CaptureMode.MIXED);
                ...
                mCameraView.startRecording(createVideoFile(), ContextCompat.getMainExecutor(getContext()),
                        new VideoCapture.OnVideoSavedCallback() {
                            ...
                            public void onVideoSaved(@NonNull File file) {
                                ...
                                long size2 = 0;
                                try {
                                    size2 = FileSizeUtil.getFileSize(mVideoFile);
                                    double size4 = FileSizeUtil.FormetFileSize(size2, 3);
                                   Log.i("upyun", "文件大小：" + size4+"MB");
                                } catch (Exception e) {
                                    e.printStackTrace();
                                }
